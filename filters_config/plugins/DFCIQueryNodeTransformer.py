...
class DFCIQueryNodeClinicalIDSubsetter(QueryNodeClinicalIDsSubsetter):
    def extended_query_node_clinical_ids_subsetter(self: MatchEngine,
        ...
        if query_node.get_query_part_by_key('STRUCTURED_SV') is not None and \
                query_node.get_query_part_value_by_key('TEST_NAME') == 'oncopanel':
            return True, {
                clinical_id
                for clinical_id
                in clinical_ids
                ...
                and query_node.get_query_part_value_by_key('TEST_NAME') == 'oncopanel':
...
class DFCIQueryNodeTransformer(QueryNodeTransformer):
    def query_node_transform(self, query_node: QueryNode) -> NoReturn:
        ...
        if 'STRUCTURAL_VARIANT_COMMENT' in whole_query:
            ...
            genes = whole_query.get('TRUE_HUGO_SYMBOL')
            ...
            if 'STRUCTURED_SV' in whole_query:
                ...
                sv_part.set_query_attr('STRUCTURAL_VARIANT_COMMENT', {"$regex": abc})
